...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #f1f5f9;">
    ...
    <div role="article" aria-roledescription="email" aria-label="Email from {{ config('app.name') }}" lang="en">
        <table style="width: 100%; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
                <td align="center" style="background-color: #f1f5f9; padding: 20px 16px;">
                    <table class="sm-w-full" style="width: 600px; max-width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                        ...
                        <tr>
                            <td class="sm-px-16" style="background-color: #ffffff; border-radius: 12px; padding: 40px 32px; box-shadow: 0 4px 16px rgba(0, 0, 0, 0.06); border: 1px solid #e5e7eb;">
                                ...
                                <div style="text-align: center; margin-bottom: 32px;">
                                    ...
                                    <p style="margin: 0; font-size: 16px; color: #00a855; font-weight: 600; text-align:center; line-height: 1.3;">
                                        See it. Feel it. Seenema
                                    </p>
                                </div>

                                <!-- Main Heading -->
                                @if (!empty($greeting))
                                    <h2 style="margin: 0 0 20px; font-size: 26px; font-weight: 700; color: #1f2937; text-align: center; line-height: 1.3;">
                                        {{ $greeting }}
                                    </h2>
                                @else
                                    @if ($level === 'error')
                                        <h2 style="margin: 0 0 20px; font-size: 26px; font-weight: 700; color: #dc2626; text-align: center; line-height: 1.3;">
                                ...
                                @foreach ($introLines as $line)
                                    <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #4b5563; text-align: center;">
                                        {{ $line }}
                                    </p>
                                @endforeach
    ...
    $buttonHoverColor = match ($level) {
        ...
        default => '#059669',
                                ...
                                <!-- Alternative Link -->
                                @isset($actionText)
                                    <div style="background: #f8fafc; border-radius: 8px; padding: 16px; margin: 24px 0; border: 1px solid #e5e7eb;">
                                        <p style="margin: 0 0 8px; font-size: 13px; color: #6b7280; line-height: 1.5; text-align: center;">
                                        ...
                                        <p style="margin: 0; word-break: break-all; font-size: 12px; text-align: center;">
                                            <a href="{{ $actionUrl }}" style="color: #00a855; text-decoration: none; font-family: monospace; padding: 4px 8px; background: #ffffff; border-radius: 4px; border: 1px solid #d1d5db; display: inline-block;">
                                                {{ $actionUrl }}
                                            </a>
                                        </p>
                                    </div>
